...
L["Can't paste that on the left side"] = "Je ne sait pas coller ceci au côté Gauche"
L["Can't paste that on the right side"] = "Je na sait pas coller ceci au côté Droit"
L["Notes"] = true
L["Note Addons"] = true
