...
L["When enabled, turns off blizzards quest watch window auto adding new quests (RELOAD REQUIRED)"] = "Wenn eingestellt, wird das automatische Hinzuf\195\188gen von Quests in Blizzards Questfenster ausgeschaltet (Erfordert Neuladen)"
...
L["When enabled, syncs the two watch lists which enables blizzard quest blobs to appear on the minimap"] = "Wenn eingestellt, werden Carbonite-Questfenster und Blizzard-Questfenster synchronisiert, so dass Blizzard-Questblobs auf der Minimap auftauchen"
...
L["When enabled, any new quest you pickup is automatically watched"] = "Wenn eingestellt, wird jede neu angenommene Quest automatisch verfolgt"
L["Auto Watch Changed Quests"] = "Automatisch ge\195\164nderte Quests verfolgen"
L["When enabled, any quest whose objective changes from you looting an item, or talking to someone is automatically watched"] = "Wenn eingestellt, werden Quests, deren Ziele sich ge\195\164ndert haben, weil ein Objekt aufgenommen oder mit jemandem gesprochen wurde, automatisch verfolgt"
L["Auto Remove Completed Quests"] = "Automatisch beendete Quests entfernen"
L["When enabled, when you complete a quest it will be removed from your watch list"] = "Wenn eingestellt, werden abgeschlossene Quests automatisch aus dem Questfenster entfernt"
L["Show distance to quest objectives"] = "Zeige Distanz zum Questziel"
L["When enabled, attempts to display how far approximately you are from a quest or objective"] = "Wenn eingestellt, wird versucht, die ungef\195\164hre Entfernung vom n\195\164chsten Questziel anzuzeigen"
L["Auto Hide Finished Objectives"] = "Abgeschlossene Ziele automatisch verstecken"
L["When enabled, objectives that are 100% complete will be removed from the list"] = "Wenn eingestellt, werden Questziele, die zu 100% erreicht wurden, von der Questliste entfernt"
L["Show Objective Amount First"] = "Questziel-Menge voranstellen"
L["When enabled, puts your objective progress before the objective instead of after"] = "Wenn eingestellt, wird die erreichte Menge an Questzielen bzw. der Fortschritt vor der Questbeschreibung dargestellt, statt dahinter"
L["Watch Scenarios"] = "Szenarios verfolgen"
L["When enabled, will place scenario status at the top of your watch window"] = "Wenn eingestellt, werden die Statusinformationen von Szenarios im Questfenster ganz oben angezeigt" 
L["Watch Achievements"] = "Erfolge verfolgen"
L["When enabled, will place any tracked achievements at the top of your watch window"] = "Wenn eingestellt, werden Erfolge, die im Questfenster verfolgt werden, ganz oben angezeigt"
L["Watch Challenge Modes"] = "Verfolge Herausforderungsmodus"
L["When enabled, will place the timer for your challenge mode at the top of your watch window"] = "Wenn eingestellt, wird die Zeitanzeige f\195\188r den Herausforderungsmodus oben im Questfenster angezeigt"
L["Show Zone Achievement if Known"] = "Zeige bekannte Zonen-Erfolge"
L["When enabled, if carbonite knows there is a zone achievement for number of quests it will display it"] = "Wenn eingestellt, wird Carbonite jene Zonen-Erfolge, die bekannt sind, anzeigen" 
L["Show Close Button"] = "Zeige Schlie\195\159en-Knopf"
L["When enabled, will place a button on the watch window to close it (RELOADS UI)"] = "Wenn eingestellt, wird Carbonite einen Schlie\195\159en-Knopf im Questfenster anzeigen (Neuladen erforderlich)"
L["Fade Entire Window"] = "Gesamtes Fenster ausblenden"
L["When enabled, if the quest watch window fades, will ensure all of it fades text and all instead of just the window itself"] = "Wenn eingestellt, wird sichergestellt, dass nicht nur das Questfenster ausgeblendet wird, sondern auch Texte und sonstiger Inhalt"
...
L["When enabled, will color your objectives based on how complete they are"] = "Wenn eingestellt, werden die Quests entsprechend ihres Fortschritts eingef\195\164rbt"
...
L["Load Quests for Levels 1-10"] = "Lade Quests f\195\164r Stufe 1-10"
L["Load Quests for Levels 11-20"] = "Lade Quests f\195\164r Stufe 11-20"
L["Load Quests for Levels 21-30"] = "Lade Quests f\195\164r Stufe 21-30"
L["Load Quests for Levels 31-40"] = "Lade Quests f\195\164r Stufe 31-40"
L["Load Quests for Levels 41-50"] = "Lade Quests f\195\164r Stufe 41-50"
L["Load Quests for Levels 51-60"] = "Lade Quests f\195\164r Stufe 51-60"
L["Load Quests for Levels 61-70"] = "Lade Quests f\195\164r Stufe 61-70"
L["Load Quests for Levels 71-80"] = "Lade Quests f\195\164r Stufe 71-80"
L["Load Quests for Levels 81-85"] = "Lade Quests f\195\164r Stufe 81-85"
L["Load Quests for Levels 86-90"] = "Lade Quests f\195\164r Stufe 86-90"
