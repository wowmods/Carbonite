...
L["When enabled, The minimap will expand to full map window size in known transparency bugged areas."] = "Quand activ\195\169, la MiniMap sera de pleine taille quans vous serez dans une zone de bug de transparence connue"
...
L["When Enabled, Carbonite will send your current location and any levelups you get to other carbonite useres in your current zone"] = "Quand activ\195\169, Carbonite envoie ma position courante et mes montées de niveau à tous les utilisateurs de Carbonite se trouvant dans ma zone courante"
