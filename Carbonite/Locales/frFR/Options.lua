...
L["When Enabled, shows additional direction text in the hud"] = "Quand activé, affiche des textes de directions additionnelles dans le HUD"
...
L["Auto Track Pals In BattleGrounds"] = "recherche automatiquement les copains dans le champ de bataille"
