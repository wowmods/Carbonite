...
L["Turns on or off displaying your battleground k/d and honor gained in chat during a match."] = "Active ou désactive l'affichage des statistiques k/d et l'honneur dans le chat durant un match." 
...
L["Allows selection of which chat window to display Carbonite messages"] = "Permet de sélectionner la fenêtre du chat pour afficher les messages Carbonite"
...
L["Hide Action Bar Gryphon Graphics"] = "Masque la barre d'action graphique de vol"
L["Attempts to hide the two gryphons on your action bar."] = "Tentatives de masquage de deux barres graphiques de vol"
...
L["When enabled, pressing 'M' will maximize the carbonite map instead of opening the world map."] = "Quand activé, presser 'M' maximise la map Carbonite ou ouver la map du monde."
...
L["Use Travel Routing"] = "Utliser route de voyage"
...
L["Restore map scale after track"] = "Restaure l'échelle de votre map après pistage"
L["When enabled, restores your previous map scale when tracking is cleared."] = "Quand activé, restaure l'échelle de map précedente quand le pistage est terminé."
...
L["Movement trail fade time"] = "Temps de transfert de mouvement"
...
L["When enabled, shows the quickbutton toolbar on the map."] = "Quand activé, affiche la barre d'outils rapide sur la map"
L["Map Tooltip Anchor"] = "Infobulle d'ancrage Map"
L["Sets the anchor point for tooltips on the map"] = "Défini le point d'ancrage pour les infobulles sur la map"
L["Map Tooltip Anchor To Map"] = "infobulle d'ancrage de map-mappée"
...
L["When enabled, makes sure the map tooltips are always on the top layer."] = "quand activé, fait que les infobulles sont toujours sur la couche supérieure de la map"
...
L["Show Map POI"] = "Afficher map POI"
...
L["Icon Scale Min"] = "Echelle mini icône"
...
L["Maximum Zones To Draw At Once"] = "Zones maximum à dessiner immédiatement"
L["Sets the number of zones you can display at once on the map"] = "Défini les zones maximum à afficher immédiatement sur la map"
...
L["Ctrl Left Click"] = "alt clic gauche"
...
L["Sets the action performed when middle clicking holding ALT"] = "Défini l'action effectuée quand clic gauche en maintenant la touche ALT"
...
L["Combine Blizzard Minimap with Carbonite Minimap"] = "Combiner blizzard MiniMap avec la MiniMap de Carbonite"
...
L["Minimap Shape is Square"] = "Forme de la Minimap est carré"
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Quand activé, Carbonite va changer la forme de la MniMap du cercle au carré" 
