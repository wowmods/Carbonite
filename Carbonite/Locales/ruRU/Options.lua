...
L["JimboBlue for guide location updates and checking"] = "JimboBlue за обновление зон модуля проводника и их проверку"
...
L["When Enabled, Carbonite will performe combat checks before any map/window functions. This eliminates other UI's from causing protected mode errors."] = "Когда Вкл., Carbonite будет проводить проверку  на нахождение в бою перед всеми функциями карты/окна. Это позволит избежать ошибок защитного режима ПИ."
